package microservice.uaa.config;
...
import microservice.uaa.controller.CustomUserDetailsService;
import microservice.uaa.security.TokenUtils;
import microservice.uaa.security.auth.RestAuthenticationEntryPoint;
import microservice.uaa.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.GET, "/ws/*"); // kasnije vrati na /ws
